...
##  Ratings data.
ratings_df = pd.read_sql("SELECT id, customer_id, product_id FROM review;", dbConnection)
...
# model.customer_model.save(RETRIEVAL_QUERY_MODEL_PATH)
# model.product_model.save(RETRIEVAL_CAN_MODEL_PATH)